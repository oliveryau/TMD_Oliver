    ...
    <form runat="server">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:Button ID="btnCreate" class="btn btn-primary nextBtn pull-right" runat="server" Text="Create" OnClick="btnCreate_User" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:RegularExpressionValidator ID="revConNo" runat="server" ControlToValidate="tbConNo" Display="Dynamic" ErrorMessage="Please enter a valid 8 digits contact number that begins with the number 8 or 9." ValidationExpression="^[89]\d{7}$" ForeColor="Red"></asp:RegularExpressionValidator>
                    </div>
                </div>
