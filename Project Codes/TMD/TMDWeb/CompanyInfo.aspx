...
<asp:ScriptManager ID="scriptmanager1" runat="server"></asp:ScriptManager>           
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Company Advertisements <asp:label runat="server" id="company_name_label"></asp:label></h1>
                    <asp:Button ID="btnBack" class="btn btn-primary nextBtn pull-left" runat="server" Text="Back" onclick="btnBack_User"/>
            </div>
        </div>
        ...
        <asp:Label id="ExtraDetailsLabel" Font-Bold="true" data-toggle="collapse" data-target="#demo" style="cursor: pointer;"><u>Advanced Search</u></asp:Label>
