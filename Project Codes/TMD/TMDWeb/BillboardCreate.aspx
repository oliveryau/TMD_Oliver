...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:Button ID="btnBack" class="btn btn-primary nextBtn pull-left" runat="server" Text="Back" onclick="btnBack_Billboard" causesValidation="false"/>

                <asp:Button ID="btnSubmit" class="btn btn-primary nextBtn pull-right" runat="server" Text="Create" OnClick="SubmitBtn_Click" />
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="rfvBillboardCode" runat="server" ControlToValidate="BBLocationCode" Display="Dynamic" ErrorMessage="Please enter a unique billboard code" ForeColor="Red"></asp:RequiredFieldValidator>
            </div>
        </div>  
    </div>
