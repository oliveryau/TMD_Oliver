...
<head>
    ...
    <div class="login-box">
        ...
        <div class="textbox">
            ...
            <h2>Login Page</h2>
            <asp:TextBox class="form-control" ID="unTB" placeholder="Email" runat="server"></asp:TextBox><br />
        ...
        <div class="textbox"> 
            ...
            <asp:TextBox class="form-control" ID="pwTB" placeholder="Password" runat="server" TextMode="Password"></asp:TextBox>
        ...
        <p>Forgot your password? <a data-toggle="modal" data-target="#forgotModal" style="cursor:pointer">Click here</a></p>
    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            <asp:TextBox class="form-control" ID="fpEmail" placeholder="Email" runat="server"></asp:TextBox>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="fpBtn" class="btn btn-primary pull-right" runat="server" Text="Submit" OnClick="fp_onclick" ValidationGroup="fpInfo" style="width: 20%"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
