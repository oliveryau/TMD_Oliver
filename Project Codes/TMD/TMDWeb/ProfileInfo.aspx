...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
            ...
            <div runat="server" id="UserView" visible="false">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <asp:Button ID="buttonEdit1" class="btn btn-primary nextBtn pull-right" runat="server" Text="Edit" onclick="btnEdit_Click"/>
                    </div>
                </div>
            ...
            <div runat="server" id="AdminView" visible="false">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <asp:Button ID="buttonEdit2" class="btn btn-primary nextBtn pull-right" runat="server" Text="Edit" onclick="btnEdit_Click"/>
                    </div>
                </div>
